...
TARGETS = {
 'Utah State||womens-soccer':   'https://utahstateaggies.com/sports/womens-soccer/roster/2024',
 'George Mason||womens-soccer': 'https://gomason.com/sports/womens-soccer/roster/2024',
 'Wyoming||womens-soccer':      'https://gowyo.com/sports/womens-soccer/roster/2024',
}
    ...
    with sync_playwright() as pw:
        ...
        for k, u in TARGETS.items():
            ...
            rows = run.build(recs, r, u, 'Low',
                             f'names only: the {S} roster widget exposes player bio links but no '
        ...
        br.close()
    json.dump(out, open('state_biolinks.json','w'), ensure_ascii=False)
